class V2::SitesController < MrttApiController
    def index
        select_clause = "sites.*, max(registration_intervention_answers.updated_at) as section_last_updated"
        ...
        @sites = current_user.is_admin ? 
            ...
            (
                ...
                @sites = Site.left_joins(:landscape, :registration_intervention_answers)
